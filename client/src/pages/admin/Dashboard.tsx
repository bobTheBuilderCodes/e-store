import { BarChart3, CreditCard, Package, Users, MessageSquare, Settings, LogOut, TrendingUp } from 'lucide-react';
      ...
      <aside className="w-64 h-screen sticky top-7 mb-4 bg-[#2a2a2a] text-white rounded-3xl m-4 p-6  flex-col hidden lg:flex ">
        ...
        <nav className="flex-1 space-y-1">
          ...
          <a href="#" className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:bg-white/5 hover:text-white transition-colors">
            ...
            <span>Messages</span>
            <span className="ml-auto w-6 h-6 bg-white-500 rounded-full flex items-center justify-center text-xs">3</span>
          </a>
          <a href="#" className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-400 hover:bg-white/5 hover:text-white transition-colors">
      ...
      <main className="flex-1 p-4 lg:p-8 overflow-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold text-gray-800">Dashboard</h3>
